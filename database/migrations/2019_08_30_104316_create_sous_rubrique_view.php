...
class CreateSousRubriqueView extends Migration
{
    ...
    public function up()
    {
        ...
        SELECT m.num_marche as 'marche', r.lib_rubrique as 'rubrique', sb.lib_sous_rubrique as 'sous_rubrique', p.date_attachement as 'periode', (c.valeur_constat / sb.valeur_cible) as 'taux_avancement_sous_rubrique' FROM 
