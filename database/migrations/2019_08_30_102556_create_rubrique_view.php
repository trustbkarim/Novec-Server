...
class CreateRubriqueView extends Migration
{
    ...
    public function up()
    {
        ...
        SELECT m.num_marche as 'marche', r.lib_rubrique as 'rubrique', p.date_attachement as 'periode', sum(c.valeur_constat / sb.valeur_cible) as 'taux_avancement_rubrique' 
